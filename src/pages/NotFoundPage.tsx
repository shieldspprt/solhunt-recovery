...
export function NotFoundPage() {
    usePageMeta({
        title: '404 Not Found',
        description: 'Page not found. SolHunt helps you recover locked SOL from your Solana wallet — safely, client-side, and non-custodially.',
        noindex: true,
    });
        ...
        <PageWrapper>
            <div className="flex min-h-[60vh] flex-col items-center justify-center px-4 text-center animate-fade-in-up">
                <div className="mx-auto mb-6 flex h-16 w-16 items-center justify-center rounded-2xl bg-shield-accent/10 border border-shield-accent/20">
                    <Zap className="h-8 w-8 text-shield-accent" aria-hidden="true" />
                </div>
