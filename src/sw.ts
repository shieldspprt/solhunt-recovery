 ...
 * to `google-fonts-v20260630-2` and `static-assets-v20260630-2` forces a
...
registerRoute(
  ...
  new NetworkFirst({ cacheName: 'google-fonts-v20260630-2', networkTimeoutSeconds: 5 })
);
...
registerRoute(
  /\.(?:js|css)$/,
  new StaleWhileRevalidate({ cacheName: 'static-assets-v20260630-2' })
);
