 ...
 * to `google-fonts-v20260624-1` and `static-assets-v20260624-1` forces a
...
registerRoute(
  ...
  new NetworkFirst({ cacheName: 'google-fonts-v20260624-1', networkTimeoutSeconds: 5 })
);
...
registerRoute(
  /\.(?:js|css)$/,
  new StaleWhileRevalidate({ cacheName: 'static-assets-v20260624-1' })
);
