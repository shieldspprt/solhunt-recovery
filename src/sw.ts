 ...
 * to `google-fonts-v20260704-2` and `static-assets-v20260704-2` forces a
...
registerRoute(
  ...
  new NetworkFirst({
    cacheName: 'google-fonts-v20260704-2',
...
registerRoute(
  /\.(?:js|css)$/,
  new StaleWhileRevalidate({ cacheName: 'static-assets-v20260704-2' })
);
