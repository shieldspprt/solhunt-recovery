 ...
 * to `google-fonts-v20260627-3` and `static-assets-v20260627-3` forces a
...
registerRoute(
  ...
  new NetworkFirst({ cacheName: 'google-fonts-v20260627-3', networkTimeoutSeconds: 5 })
);
...
registerRoute(
  /\.(?:js|css)$/,
  new StaleWhileRevalidate({ cacheName: 'static-assets-v20260627-3' })
);
