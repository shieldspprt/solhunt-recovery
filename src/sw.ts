 ...
 * to `google-fonts-v20260706-1` and `static-assets-v20260706-1` forces a
...
registerRoute(
  ...
  new NetworkFirst({
    cacheName: 'google-fonts-v20260706-1',
...
registerRoute(
  /\.(?:js|css)$/,
  new StaleWhileRevalidate({ cacheName: 'static-assets-v20260706-1' })
);
